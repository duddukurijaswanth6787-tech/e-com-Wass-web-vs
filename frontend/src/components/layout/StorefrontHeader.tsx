...
export function StorefrontHeader() {
  ...
  const isBarEnabledSetting = Boolean(
    typedSettings?.announcementBarEnabled === true ||
    typedSettings?.announcement_bar_enabled === 'true' ||
    typedSettings?.announcement_bar_enabled === true
  );
  const mobileAnnouncementEnabled = Boolean(
    typedSettings?.announcementBarMobileEnabled === true ||
    typedSettings?.announcement_bar_mobile_enabled === 'true' ||
    typedSettings?.announcement_bar_mobile_enabled === true
  );
