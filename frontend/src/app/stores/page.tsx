...
const STORES = [
  {
    ...
    name: 'Vasanthi Creations Flagship Boutique',
    city: 'Hyderabad',
    address: 'Road No. 36, Jubilee Hills, Hyderabad, Telangana 500033',
    phone: '+91 40 2354 0000',
    email: 'jubileehills@vasanthicreations.in',
